...
def build_prop_circular_obscuration(wf, radius, xc = 0.0, yc = 0.0, **kwargs):
    ...
    return proper.prop_shift_center(proper.prop_ellipse(wf, radius, radius, xc, yc, NORM = norm, DARK = True))
