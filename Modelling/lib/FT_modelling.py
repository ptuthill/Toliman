...
def FT_model_broadband(pupil, aperture, chip_dim, wavels, weights, foc_length, pix_size, transform_size, q1, q2, polar=True):
    """
    ...
    for wavel, weight in zip(wavels, weights):
        im_out += weight * FT_model(pupil, aperture, chip_dim, wl, foc_length, pix_size, transform_size, q1, q2, polar=True)
